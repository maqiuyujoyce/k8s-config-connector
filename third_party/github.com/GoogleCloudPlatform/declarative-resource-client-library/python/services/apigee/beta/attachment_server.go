...
func ProtoToAttachment(p *betapb.ApigeeBetaAttachment) *beta.Attachment {
	obj := &beta.Attachment{
...
func AttachmentToProto(resource *beta.Attachment) *betapb.ApigeeBetaAttachment {
	p := &betapb.ApigeeBetaAttachment{}
...
func (s *AttachmentServer) applyAttachment(ctx context.Context, c *beta.Client, request *betapb.ApplyApigeeBetaAttachmentRequest) (*betapb.ApigeeBetaAttachment, error) {
...
// applyApigeeBetaAttachment handles the gRPC request by passing it to the underlying Attachment Apply() method.
func (s *AttachmentServer) ApplyApigeeBetaAttachment(ctx context.Context, request *betapb.ApplyApigeeBetaAttachmentRequest) (*betapb.ApigeeBetaAttachment, error) {
...
func (s *AttachmentServer) DeleteApigeeBetaAttachment(ctx context.Context, request *betapb.DeleteApigeeBetaAttachmentRequest) (*emptypb.Empty, error) {
...
// ListApigeeBetaAttachment handles the gRPC request by passing it to the underlying AttachmentList() method.
func (s *AttachmentServer) ListApigeeBetaAttachment(ctx context.Context, request *betapb.ListApigeeBetaAttachmentRequest) (*betapb.ListApigeeBetaAttachmentResponse, error) {
	cl, err := createConfigAttachment(ctx, request.GetServiceAccountFile())
	if err != nil {
		return nil, err
	}
	...
	var protos []*betapb.ApigeeBetaAttachment
	for _, r := range resources.Items {
		rp := AttachmentToProto(r)
		protos = append(protos, rp)
	}
	p := &betapb.ListApigeeBetaAttachmentResponse{}
	p.SetItems(protos)
	return p, nil
}

func createConfigAttachment(ctx context.Context, service_account_file string) (*beta.Client, error) {
