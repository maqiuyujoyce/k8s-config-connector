...
func ProtoToComputeAlphaVpnTunnelStatusEnum(e alphapb.ComputeAlphaVpnTunnelStatusEnum) *alpha.VpnTunnelStatusEnum {
	if e == 0 {
		return nil
	}
	if n, ok := alphapb.ComputeAlphaVpnTunnelStatusEnum_name[int32(e)]; ok {
		e := alpha.VpnTunnelStatusEnum(n[len("ComputeAlphaVpnTunnelStatusEnum"):])
		return &e
	}
	return nil
}
...
func ProtoToVpnTunnel(p *alphapb.ComputeAlphaVpnTunnel) *alpha.VpnTunnel {
	obj := &alpha.VpnTunnel{
		...
		Status:                       ProtoToComputeAlphaVpnTunnelStatusEnum(p.GetStatus()),
...
func ComputeAlphaVpnTunnelStatusEnumToProto(e *alpha.VpnTunnelStatusEnum) alphapb.ComputeAlphaVpnTunnelStatusEnum {
	if e == nil {
		return alphapb.ComputeAlphaVpnTunnelStatusEnum(0)
	}
	if v, ok := alphapb.ComputeAlphaVpnTunnelStatusEnum_value["VpnTunnelStatusEnum"+string(*e)]; ok {
		return alphapb.ComputeAlphaVpnTunnelStatusEnum(v)
	}
	return alphapb.ComputeAlphaVpnTunnelStatusEnum(0)
}

// VpnTunnelToProto converts a VpnTunnel resource to its proto representation.
func VpnTunnelToProto(resource *alpha.VpnTunnel) *alphapb.ComputeAlphaVpnTunnel {
	p := &alphapb.ComputeAlphaVpnTunnel{}
	...
	p.SetStatus(ComputeAlphaVpnTunnelStatusEnumToProto(resource.Status))
...
func (s *VpnTunnelServer) applyVpnTunnel(ctx context.Context, c *alpha.Client, request *alphapb.ApplyComputeAlphaVpnTunnelRequest) (*alphapb.ComputeAlphaVpnTunnel, error) {
...
// applyComputeAlphaVpnTunnel handles the gRPC request by passing it to the underlying VpnTunnel Apply() method.
func (s *VpnTunnelServer) ApplyComputeAlphaVpnTunnel(ctx context.Context, request *alphapb.ApplyComputeAlphaVpnTunnelRequest) (*alphapb.ComputeAlphaVpnTunnel, error) {
...
func (s *VpnTunnelServer) DeleteComputeAlphaVpnTunnel(ctx context.Context, request *alphapb.DeleteComputeAlphaVpnTunnelRequest) (*emptypb.Empty, error) {
...
// ListComputeAlphaVpnTunnel handles the gRPC request by passing it to the underlying VpnTunnelList() method.
func (s *VpnTunnelServer) ListComputeAlphaVpnTunnel(ctx context.Context, request *alphapb.ListComputeAlphaVpnTunnelRequest) (*alphapb.ListComputeAlphaVpnTunnelResponse, error) {
	cl, err := createConfigVpnTunnel(ctx, request.GetServiceAccountFile())
	if err != nil {
		return nil, err
	}
	...
	var protos []*alphapb.ComputeAlphaVpnTunnel
	for _, r := range resources.Items {
		rp := VpnTunnelToProto(r)
		protos = append(protos, rp)
	}
	p := &alphapb.ListComputeAlphaVpnTunnelResponse{}
	p.SetItems(protos)
	return p, nil
}

func createConfigVpnTunnel(ctx context.Context, service_account_file string) (*alpha.Client, error) {
