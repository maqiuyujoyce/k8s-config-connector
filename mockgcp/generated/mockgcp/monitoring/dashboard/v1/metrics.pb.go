...
// 	protoc        v3.12.4
// source: mockgcp/monitoring/dashboard/v1/metrics.proto
...
func (SparkChartType) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes[0].Descriptor()
}

func (SparkChartType) Type() protoreflect.EnumType {
	return &file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes[0]
}
...
func (SparkChartType) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescGZIP(), []int{0}
}
...
func (Threshold_Color) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes[1].Descriptor()
}

func (Threshold_Color) Type() protoreflect.EnumType {
	return &file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes[1]
}
...
func (Threshold_Color) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescGZIP(), []int{3, 0}
}
...
func (Threshold_Direction) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes[2].Descriptor()
}

func (Threshold_Direction) Type() protoreflect.EnumType {
	return &file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes[2]
}
...
func (Threshold_Direction) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescGZIP(), []int{3, 1}
}
...
func (Threshold_TargetAxis) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes[3].Descriptor()
}

func (Threshold_TargetAxis) Type() protoreflect.EnumType {
	return &file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes[3]
}
...
func (Threshold_TargetAxis) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescGZIP(), []int{3, 2}
}
...
func (x *TimeSeriesQuery) Reset() {
	*x = TimeSeriesQuery{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[0]
...
func (x *TimeSeriesFilter) Reset() {
	*x = TimeSeriesFilter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TimeSeriesFilter) Descriptor() ([]byte, []int) {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescGZIP(), []int{1}
}
...
func (x *TimeSeriesFilterRatio) Reset() {
	*x = TimeSeriesFilterRatio{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TimeSeriesFilterRatio) Descriptor() ([]byte, []int) {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescGZIP(), []int{2}
}
...
type Threshold struct {
	...
	Color Threshold_Color `protobuf:"varint,3,opt,name=color,proto3,enum=mockgcp.monitoring.dashboard.v1.Threshold_Color" json:"color,omitempty"`
	// The direction for the current threshold. Direction is not allowed in a
	// XyChart.
	Direction Threshold_Direction `protobuf:"varint,4,opt,name=direction,proto3,enum=mockgcp.monitoring.dashboard.v1.Threshold_Direction" json:"direction,omitempty"`
	// The target axis to use for plotting the threshold. Target axis is not
	// allowed in a Scorecard.
	TargetAxis Threshold_TargetAxis `protobuf:"varint,5,opt,name=target_axis,json=targetAxis,proto3,enum=mockgcp.monitoring.dashboard.v1.Threshold_TargetAxis" json:"target_axis,omitempty"`
}

func (x *Threshold) Reset() {
	*x = Threshold{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Threshold) Descriptor() ([]byte, []int) {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescGZIP(), []int{3}
}
...
func (x *TimeSeriesFilterRatio_RatioPart) Reset() {
	*x = TimeSeriesFilterRatio_RatioPart{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TimeSeriesFilterRatio_RatioPart) Descriptor() ([]byte, []int) {
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescGZIP(), []int{2, 0}
}
...
var File_mockgcp_monitoring_dashboard_v1_metrics_proto protoreflect.FileDescriptor

var file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDesc = []byte{
	...
	0x6f, 0x1a, 0x2c, 0x6d, 0x6f, 0x63, 0x6b, 0x67, 0x63, 0x70, 0x2f, 0x6d, 0x6f, 0x6e, 0x69, 0x74,
	...
	0xb9, 0x03, 0x0a, 0x0f, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x69, 0x65, 0x73, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x12, 0x61, 0x0a, 0x12, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x69,
	0x65, 0x73, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x65, 0x72, 0x48, 0x00, 0x52, 0x10, 0x74, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x69, 0x65, 0x73,
	0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x71, 0x0a, 0x18, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x73,
	0x65, 0x72, 0x69, 0x65, 0x73, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x5f, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x6d, 0x6f, 0x63, 0x6b, 0x67,
	...
	,
	...
	0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x4e, 0x0a,
	0x0b, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x6d, 0x6f, 0x63, 0x6b, 0x67, 0x63, 0x70, 0x2e, 0x6d, 0x6f, 0x6e,
	...
	0x52, 0x0b, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x61, 0x0a,
	0x15, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x5f, 0x61, 0x67, 0x67, 0x72, 0x65,
	0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x6d,
	...
	0x12, 0x6e, 0x0a, 0x17, 0x70, 0x69, 0x63, 0x6b, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x73, 0x65,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x50, 0x69, 0x63, 0x6b, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x69,
	0x65, 0x73, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x48, 0x00, 0x52, 0x14, 0x70, 0x69, 0x63, 0x6b,
	0x54, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x69, 0x65, 0x73, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72,
	0x12, 0x87, 0x01, 0x0a, 0x1e, 0x73, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x61, 0x6c,
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x69, 0x65, 0x73, 0x5f, 0x66, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3c, 0x2e, 0x6d, 0x6f, 0x63, 0x6b,
	...
	,
	...
	0x69, 0x6f, 0x2e, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x50, 0x61, 0x72, 0x74, 0x52, 0x0b, 0x64, 0x65,
	0x6e, 0x6f, 0x6d, 0x69, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x61, 0x0a, 0x15, 0x73, 0x65, 0x63,
	0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x5f, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x6d, 0x6f, 0x63, 0x6b, 0x67,
	0x63, 0x70, 0x2e, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61,
	...
	0x79, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x6e, 0x0a, 0x17,
	0x70, 0x69, 0x63, 0x6b, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x69, 0x65, 0x73,
	0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e,
	...
	,
	...
	0x42, 0x0f, 0x0a, 0x0d, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x22, 0xd9, 0x03, 0x0a, 0x09, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x12,
	...
	0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x46, 0x0a, 0x05, 0x63,
	0x6f, 0x6c, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x30, 0x2e, 0x6d, 0x6f, 0x63,
	0x6b, 0x67, 0x63, 0x70, 0x2e, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x2e,
	...
	0x6c, 0x6f, 0x72, 0x12, 0x52, 0x0a, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
...
var (
	file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescOnce sync.Once
	file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescData = file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDesc
)

func file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescGZIP() []byte {
	file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescOnce.Do(func() {
		file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescData = protoimpl.X.CompressGZIP(file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescData)
	})
	return file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDescData
}

var file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_mockgcp_monitoring_dashboard_v1_metrics_proto_goTypes = []interface{}{
	(SparkChartType)(0),                     // 0: mockgcp.monitoring.dashboard.v1.SparkChartType
	(Threshold_Color)(0),                    // 1: mockgcp.monitoring.dashboard.v1.Threshold.Color
	(Threshold_Direction)(0),                // 2: mockgcp.monitoring.dashboard.v1.Threshold.Direction
	(Threshold_TargetAxis)(0),               // 3: mockgcp.monitoring.dashboard.v1.Threshold.TargetAxis
	(*TimeSeriesQuery)(nil),                 // 4: mockgcp.monitoring.dashboard.v1.TimeSeriesQuery
	(*TimeSeriesFilter)(nil),                // 5: mockgcp.monitoring.dashboard.v1.TimeSeriesFilter
	(*TimeSeriesFilterRatio)(nil),           // 6: mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio
	(*Threshold)(nil),                       // 7: mockgcp.monitoring.dashboard.v1.Threshold
	(*TimeSeriesFilterRatio_RatioPart)(nil), // 8: mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio.RatioPart
	(*Aggregation)(nil),                     // 9: mockgcp.monitoring.dashboard.v1.Aggregation
	(*PickTimeSeriesFilter)(nil),            // 10: mockgcp.monitoring.dashboard.v1.PickTimeSeriesFilter
	(*StatisticalTimeSeriesFilter)(nil),     // 11: mockgcp.monitoring.dashboard.v1.StatisticalTimeSeriesFilter
}
var file_mockgcp_monitoring_dashboard_v1_metrics_proto_depIdxs = []int32{
	5,  // 0: mockgcp.monitoring.dashboard.v1.TimeSeriesQuery.time_series_filter:type_name -> mockgcp.monitoring.dashboard.v1.TimeSeriesFilter
	6,  // 1: mockgcp.monitoring.dashboard.v1.TimeSeriesQuery.time_series_filter_ratio:type_name -> mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio
	9,  // 2: mockgcp.monitoring.dashboard.v1.TimeSeriesFilter.aggregation:type_name -> mockgcp.monitoring.dashboard.v1.Aggregation
	9,  // 3: mockgcp.monitoring.dashboard.v1.TimeSeriesFilter.secondary_aggregation:type_name -> mockgcp.monitoring.dashboard.v1.Aggregation
	10, // 4: mockgcp.monitoring.dashboard.v1.TimeSeriesFilter.pick_time_series_filter:type_name -> mockgcp.monitoring.dashboard.v1.PickTimeSeriesFilter
	11, // 5: mockgcp.monitoring.dashboard.v1.TimeSeriesFilter.statistical_time_series_filter:type_name -> mockgcp.monitoring.dashboard.v1.StatisticalTimeSeriesFilter
	8,  // 6: mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio.numerator:type_name -> mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio.RatioPart
	8,  // 7: mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio.denominator:type_name -> mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio.RatioPart
	9,  // 8: mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio.secondary_aggregation:type_name -> mockgcp.monitoring.dashboard.v1.Aggregation
	10, // 9: mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio.pick_time_series_filter:type_name -> mockgcp.monitoring.dashboard.v1.PickTimeSeriesFilter
	11, // 10: mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio.statistical_time_series_filter:type_name -> mockgcp.monitoring.dashboard.v1.StatisticalTimeSeriesFilter
	1,  // 11: mockgcp.monitoring.dashboard.v1.Threshold.color:type_name -> mockgcp.monitoring.dashboard.v1.Threshold.Color
	2,  // 12: mockgcp.monitoring.dashboard.v1.Threshold.direction:type_name -> mockgcp.monitoring.dashboard.v1.Threshold.Direction
	3,  // 13: mockgcp.monitoring.dashboard.v1.Threshold.target_axis:type_name -> mockgcp.monitoring.dashboard.v1.Threshold.TargetAxis
	9,  // 14: mockgcp.monitoring.dashboard.v1.TimeSeriesFilterRatio.RatioPart.aggregation:type_name -> mockgcp.monitoring.dashboard.v1.Aggregation
...
func init() { file_mockgcp_monitoring_dashboard_v1_metrics_proto_init() }
func file_mockgcp_monitoring_dashboard_v1_metrics_proto_init() {
	if File_mockgcp_monitoring_dashboard_v1_metrics_proto != nil {
		return
	}
	file_mockgcp_monitoring_dashboard_v1_common_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*TimeSeriesFilter_PickTimeSeriesFilter)(nil),
		(*TimeSeriesFilter_StatisticalTimeSeriesFilter)(nil),
	}
	file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDesc,
			NumEnums:      4,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mockgcp_monitoring_dashboard_v1_metrics_proto_goTypes,
		DependencyIndexes: file_mockgcp_monitoring_dashboard_v1_metrics_proto_depIdxs,
		EnumInfos:         file_mockgcp_monitoring_dashboard_v1_metrics_proto_enumTypes,
		MessageInfos:      file_mockgcp_monitoring_dashboard_v1_metrics_proto_msgTypes,
	}.Build()
	File_mockgcp_monitoring_dashboard_v1_metrics_proto = out.File
	file_mockgcp_monitoring_dashboard_v1_metrics_proto_rawDesc = nil
	file_mockgcp_monitoring_dashboard_v1_metrics_proto_goTypes = nil
	file_mockgcp_monitoring_dashboard_v1_metrics_proto_depIdxs = nil
}
