...
// 	protoc        v3.12.4
// source: mockgcp/cloud/aiplatform/v1beta1/featurestore.proto
...
func (Featurestore_State) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_enumTypes[0].Descriptor()
}

func (Featurestore_State) Type() protoreflect.EnumType {
	return &file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_enumTypes[0]
}
...
func (Featurestore_State) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescGZIP(), []int{0, 0}
}
...
type Featurestore struct {
	...
	State Featurestore_State `protobuf:"varint,8,opt,name=state,proto3,enum=mockgcp.cloud.aiplatform.v1beta1.Featurestore_State" json:"state,omitempty"`
...
func (x *Featurestore) Reset() {
	*x = Featurestore{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_msgTypes[0]
...
func (*Featurestore) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescGZIP(), []int{0}
}
...
func (x *Featurestore_OnlineServingConfig) Reset() {
	*x = Featurestore_OnlineServingConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *Featurestore_OnlineServingConfig_Scaling) Reset() {
	*x = Featurestore_OnlineServingConfig_Scaling{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Featurestore_OnlineServingConfig_Scaling) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
var File_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto protoreflect.FileDescriptor

var file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x83, 0x0a, 0x0a,
	0x0c, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x17, 0x0a,
	...
	0x74, 0x61, 0x67, 0x12, 0x57, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x06, 0x20,
	...
	0x6f, 0x72, 0x65, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x42,
	0x03, 0xe0, 0x41, 0x01, 0x52, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x12, 0x7b, 0x0a, 0x15,
	0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x5f, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x42, 0x2e, 0x6d, 0x6f,
	...
	0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x4f, 0x6e, 0x6c, 0x69,
	0x6e, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42,
	0x03, 0xe0, 0x41, 0x01, 0x52, 0x13, 0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x4f, 0x0a, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x34, 0x2e, 0x6d, 0x6f, 0x63, 0x6b, 0x67,
	...
	0x75, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x03,
	0xe0, 0x41, 0x03, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x3a, 0x0a, 0x17, 0x6f, 0x6e,
	0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x74, 0x6c,
	0x5f, 0x64, 0x61, 0x79, 0x73, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x05, 0x42, 0x03, 0xe0, 0x41, 0x01,
	0x52, 0x14, 0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x54,
	0x74, 0x6c, 0x44, 0x61, 0x79, 0x73, 0x12, 0x5e, 0x0a, 0x0f, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70,
	...
	0x74, 0x69, 0x73, 0x66, 0x69, 0x65, 0x73, 0x50, 0x7a, 0x69, 0x1a, 0xbd, 0x02, 0x0a, 0x13, 0x4f,
	0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x12, 0x28, 0x0a, 0x10, 0x66, 0x69, 0x78, 0x65, 0x64, 0x5f, 0x6e, 0x6f, 0x64, 0x65,
	0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x66, 0x69,
	0x78, 0x65, 0x64, 0x4e, 0x6f, 0x64, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x64, 0x0a, 0x07,
	0x73, 0x63, 0x61, 0x6c, 0x69, 0x6e, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x4a, 0x2e,
	...
	0x65, 0x7d, 0x42, 0xe9, 0x01, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x6f, 0x63, 0x6b, 0x67,
	0x63, 0x70, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x61, 0x69, 0x70, 0x6c, 0x61, 0x74, 0x66,
	0x6f, 0x72, 0x6d, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x11, 0x46, 0x65, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var (
	file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescOnce sync.Once
	file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescData = file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDesc
)

func file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescGZIP() []byte {
	file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescOnce.Do(func() {
		file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescData = protoimpl.X.CompressGZIP(file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescData)
	})
	return file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDescData
}

var file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_goTypes = []interface{}{
	(Featurestore_State)(0),                  // 0: mockgcp.cloud.aiplatform.v1beta1.Featurestore.State
	(*Featurestore)(nil),                     // 1: mockgcp.cloud.aiplatform.v1beta1.Featurestore
	(*Featurestore_OnlineServingConfig)(nil), // 2: mockgcp.cloud.aiplatform.v1beta1.Featurestore.OnlineServingConfig
	nil,                                      // 3: mockgcp.cloud.aiplatform.v1beta1.Featurestore.LabelsEntry
	(*Featurestore_OnlineServingConfig_Scaling)(nil), // 4: mockgcp.cloud.aiplatform.v1beta1.Featurestore.OnlineServingConfig.Scaling
	(*timestamp.Timestamp)(nil),                      // 5: google.protobuf.Timestamp
	(*EncryptionSpec)(nil),                           // 6: mockgcp.cloud.aiplatform.v1beta1.EncryptionSpec
}
var file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_depIdxs = []int32{
	5, // 0: mockgcp.cloud.aiplatform.v1beta1.Featurestore.create_time:type_name -> google.protobuf.Timestamp
	5, // 1: mockgcp.cloud.aiplatform.v1beta1.Featurestore.update_time:type_name -> google.protobuf.Timestamp
	3, // 2: mockgcp.cloud.aiplatform.v1beta1.Featurestore.labels:type_name -> mockgcp.cloud.aiplatform.v1beta1.Featurestore.LabelsEntry
	2, // 3: mockgcp.cloud.aiplatform.v1beta1.Featurestore.online_serving_config:type_name -> mockgcp.cloud.aiplatform.v1beta1.Featurestore.OnlineServingConfig
	0, // 4: mockgcp.cloud.aiplatform.v1beta1.Featurestore.state:type_name -> mockgcp.cloud.aiplatform.v1beta1.Featurestore.State
	6, // 5: mockgcp.cloud.aiplatform.v1beta1.Featurestore.encryption_spec:type_name -> mockgcp.cloud.aiplatform.v1beta1.EncryptionSpec
	4, // 6: mockgcp.cloud.aiplatform.v1beta1.Featurestore.OnlineServingConfig.scaling:type_name -> mockgcp.cloud.aiplatform.v1beta1.Featurestore.OnlineServingConfig.Scaling
...
func init() { file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_init() }
func file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_init() {
	if File_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto != nil {
		return
	}
	file_mockgcp_cloud_aiplatform_v1beta1_encryption_spec_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_goTypes,
		DependencyIndexes: file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_depIdxs,
		EnumInfos:         file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_enumTypes,
		MessageInfos:      file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_msgTypes,
	}.Build()
	File_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto = out.File
	file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_rawDesc = nil
	file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_goTypes = nil
	file_mockgcp_cloud_aiplatform_v1beta1_featurestore_proto_depIdxs = nil
}
