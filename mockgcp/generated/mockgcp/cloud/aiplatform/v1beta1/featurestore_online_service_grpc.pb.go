...
func (c *featurestoreOnlineServingServiceClient) ReadFeatureValues(ctx context.Context, in *ReadFeatureValuesRequest, opts ...grpc.CallOption) (*ReadFeatureValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1beta1.FeaturestoreOnlineServingService/ReadFeatureValues", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *featurestoreOnlineServingServiceClient) StreamingReadFeatureValues(ctx context.Context, in *StreamingReadFeatureValuesRequest, opts ...grpc.CallOption) (FeaturestoreOnlineServingService_StreamingReadFeatureValuesClient, error) {
	stream, err := c.cc.NewStream(ctx, &FeaturestoreOnlineServingService_ServiceDesc.Streams[0], "/mockgcp.cloud.aiplatform.v1beta1.FeaturestoreOnlineServingService/StreamingReadFeatureValues", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *featurestoreOnlineServingServiceClient) WriteFeatureValues(ctx context.Context, in *WriteFeatureValuesRequest, opts ...grpc.CallOption) (*WriteFeatureValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1beta1.FeaturestoreOnlineServingService/WriteFeatureValues", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedFeaturestoreOnlineServingServiceServer
...
// UnimplementedFeaturestoreOnlineServingServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedFeaturestoreOnlineServingServiceServer) mustEmbedUnimplementedFeaturestoreOnlineServingServiceServer() {
}
...
func _FeaturestoreOnlineServingService_ReadFeatureValues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1beta1.FeaturestoreOnlineServingService/ReadFeatureValues",
	}
...
func _FeaturestoreOnlineServingService_WriteFeatureValues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1beta1.FeaturestoreOnlineServingService/WriteFeatureValues",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var FeaturestoreOnlineServingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mockgcp.cloud.aiplatform.v1beta1.FeaturestoreOnlineServingService",
	...
	Metadata: "mockgcp/cloud/aiplatform/v1beta1/featurestore_online_service.proto",
}
