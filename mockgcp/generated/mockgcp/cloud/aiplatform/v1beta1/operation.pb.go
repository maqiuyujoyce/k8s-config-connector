...
// 	protoc        v3.12.4
// source: mockgcp/cloud/aiplatform/v1beta1/operation.proto
...
func (x *GenericOperationMetadata) Reset() {
	*x = GenericOperationMetadata{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_msgTypes[0]
...
func (*GenericOperationMetadata) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDescGZIP(), []int{0}
}
...
func (x *DeleteOperationMetadata) Reset() {
	*x = DeleteOperationMetadata{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteOperationMetadata) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDescGZIP(), []int{1}
}
...
var file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDesc = []byte{
	...
	0xe2, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63, 0x4f, 0x70, 0x65, 0x72, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x42, 0x0a, 0x10,
	...
	0x54, 0x69, 0x6d, 0x65, 0x22, 0x80, 0x01, 0x0a, 0x17, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0xe6, 0x01, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e,
...
var (
	file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDescOnce sync.Once
	file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDescData = file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDesc
)

func file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDescGZIP() []byte {
	file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDescOnce.Do(func() {
		file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDescData = protoimpl.X.CompressGZIP(file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDescData)
	})
	return file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDescData
}

var file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_goTypes = []interface{}{
	(*GenericOperationMetadata)(nil), // 0: mockgcp.cloud.aiplatform.v1beta1.GenericOperationMetadata
	(*DeleteOperationMetadata)(nil),  // 1: mockgcp.cloud.aiplatform.v1beta1.DeleteOperationMetadata
	(*status.Status)(nil),            // 2: google.rpc.Status
	(*timestamp.Timestamp)(nil),      // 3: google.protobuf.Timestamp
}
var file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_depIdxs = []int32{
	2, // 0: mockgcp.cloud.aiplatform.v1beta1.GenericOperationMetadata.partial_failures:type_name -> google.rpc.Status
	3, // 1: mockgcp.cloud.aiplatform.v1beta1.GenericOperationMetadata.create_time:type_name -> google.protobuf.Timestamp
	3, // 2: mockgcp.cloud.aiplatform.v1beta1.GenericOperationMetadata.update_time:type_name -> google.protobuf.Timestamp
	0, // 3: mockgcp.cloud.aiplatform.v1beta1.DeleteOperationMetadata.generic_metadata:type_name -> mockgcp.cloud.aiplatform.v1beta1.GenericOperationMetadata
...
func init() { file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_init() }
func file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_init() {
	if File_mockgcp_cloud_aiplatform_v1beta1_operation_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_goTypes,
		DependencyIndexes: file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_depIdxs,
		MessageInfos:      file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_msgTypes,
	}.Build()
	File_mockgcp_cloud_aiplatform_v1beta1_operation_proto = out.File
	file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_rawDesc = nil
	file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_goTypes = nil
	file_mockgcp_cloud_aiplatform_v1beta1_operation_proto_depIdxs = nil
}
